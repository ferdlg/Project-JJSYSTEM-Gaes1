    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idcategoriaservicio', models.ForeignKey(blank=True, db_column='idCategoriaServicio', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='ProductosServicios.categoriasservicios')),
            ],
            options={
                'db_table': 'servicios',
            },
